...
def run_test_count_cosines_from():
    ...
    expected = 2
    answer = count_cosines_from(1, 5, 0.11)
    ...
    expected = 3
    answer = count_cosines_from(1, 10, 0.44)
...
def run_test_sum_unit_fractions_from():
    ...
    expected = 0.509  # This is APPROXIMATELY the correct answer.
    ...
    expected = 0.236  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(8, 9)
